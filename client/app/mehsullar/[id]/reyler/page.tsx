...
export default function Page() {
  ...
  return (
    <>
      <MetaHead
        title={`Məhsul Reyləri - ${productById?.title}`}
        description={`Məhsul haqqında rey və şərhləri oxuyun. ${productById?.title} üçün istifadəçi rəyləri və qiymətləndirmələrini kəşf edin.`}
        keywords={`${productById?.title}, məhsul reyleri, istifadəçi rəyləri, online alış-veriş`}
      />
