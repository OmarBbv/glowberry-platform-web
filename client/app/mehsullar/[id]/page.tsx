...
export default function page() {
  ...
  return (
    <>
      <MetaHead
        title={`Məhsul - ${product?.title}`}
        description={`Məhsul haqqında ətraflı məlumat, qiymət və şərhləri oxuyun. ${product?.title} üçün ən yaxşı təklifləri kəşf edin.`}
        keywords={`${product?.title}, məhsul, online alış-veriş, qiymət, şərhlər`}
      />
